      ...
      <fieldset>
          ...
          <div class="board_list_ty1">
                  <table summary="">
                          ...
                          <div>${freeboardVO.memberVO.title}</div>
                          <label for="subject">등록자</label>
                          <div>${freeboardVO.memberVO.writer}</div>
                          <label for="subject">등록일</label>
                          <div>${freeboardVO.memberVO.createat}</div>
                          <label for="subject">조회수</label>
                          <div>${freeboardVO.memberVO.view}</div>
