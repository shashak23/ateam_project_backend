...
<body>
  <div class="header_container">
    <section class="header">
      ...
      <c:choose>
		  <c:when test="${not empty sessionScope._LOGIN_USER_ and sessionScope._LOGIN_USER_.memberType eq 'GENERAL'}">
			    <div class="my_icon">
		    ...
		    <c:when test="${not empty sessionScope._LOGIN_USER_ and sessionScope._LOGIN_USER_.memberType eq 'COMPANY'}">
			    <div class="my_icon">
